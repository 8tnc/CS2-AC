...
#include <utility>
#include <vector>
// Keep tinyformat in this shared header so every Windows translation unit uses the same configuration.
...
#define CS2AC_STREQ(a, b)             (V_strcmp(a, b) == 0)
#define CS2AC_STREQI(a, b)            (V_stricmp(a, b) == 0)
#define CS2AC_STREQLEN(a, b, maxlen)  (V_strncmp(a, b, maxlen) == 0)
#define CS2AC_STREQILEN(a, b, maxlen) (V_strnicmp(a, b, maxlen) == 0)
// ARRAYSIZE gets undef'd if metamod_oslink is included after commonmacros.h. We can use our own implementation instead.
#define CS2AC_ARRAYSIZE(a)       ((sizeof(a) / sizeof(*(a))) / static_cast<size_t>(!(sizeof(a) % sizeof(*(a)))))
#define CS2AC_FOURCC(a, b, c, d) ((u32)(((d) << 24) | ((c) << 16) | ((b) << 8) | (a)))

#define VPROF_LEVEL 1

// clang-format off
#define VPROF_SCOPE_BEGIN_CS2AC(tag) do { VPROF_(tag, 1, "CS2AC", false, 0)
// clang-format on
