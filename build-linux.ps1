...
$plugin = Join-Path $PSScriptRoot "$BuildDirectory\package\game\csgo\addons\cs2ac\bin\linuxsteamrt64\cs2ac.so"
if (-not (Test-Path $plugin)) {
	throw 'The build finished without producing cs2ac.so.'
}
