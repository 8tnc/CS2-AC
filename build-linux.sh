...
plugin="$SOURCE_DIR/$BUILD_DIR/package/game/csgo/addons/cs2ac/bin/linuxsteamrt64/cs2ac.so"
[[ -f "$plugin" ]] || { echo "The build finished without producing cs2ac.so." >&2; exit 1; }
